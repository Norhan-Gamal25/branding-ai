...
def generate_pdf(
    ...
    if logo_prompts:
        ...
        pdf.body_text(
            ...
            "Generated by Branding AI — powered by a multi-provider LLM ladder "
    ...
    pdf.body_text(
        ...
        "Technology stack:\n"
        "  * Platform Engineer (Landing Pages) — rich design-system scaffold + Groq\n"
        "  * Ethical Strategy Director (Chat & Visuals) — Groq llama-3.3-70b / gpt-oss-120b\n"
        "  * Multi-provider fallback ladder: Groq (4 model pools) → OpenRouter → Hugging Face → OpenAI\n\n"
